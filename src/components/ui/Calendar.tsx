  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: 'h-10 w-9 text-center rounded-full text-sm p-0 relative [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:h-[20px] [&:has([aria-selected])]:bg-pr-500 first:[&:has([aria-selected])]:rounded-full focus-within:relative focus-within:z-20',
        day: cn(
